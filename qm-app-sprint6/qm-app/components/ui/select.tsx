...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-11 w-full items-center justify-between rounded-lg border border-border bg-secondary/50 px-4 py-2.5 text-sm",
      "ring-offset-background placeholder:text-muted-foreground/60",
      "focus:outline-none focus:border-amethyst-bright focus:ring-2 focus:ring-amethyst-bright/20",
