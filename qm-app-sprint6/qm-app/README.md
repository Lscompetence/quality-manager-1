...
**19 mini-apps couvrant 26/32 indicateurs RNQ V9** — les 6 indicateurs restants sont gérés via la page indicateur générique avec dépôt libre de preuves.
...
│   │   ├── registry.ts            # 19 mini-apps enregistrées
