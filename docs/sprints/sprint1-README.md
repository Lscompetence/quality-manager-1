...
- ⏭ **Sprint 2** — Cœur app : sidebar + dashboard dossier + routing critères/indicateurs + composant Attachment universel
- ⏭ **Sprint 3** — Mini-apps groupe 1 (les plus simples : 6)
- ⏭ **Sprint 4** — Mini-apps groupe 2 (moyennes : 7)
- ⏭ **Sprint 5** — Mini-apps groupe 3 (complexes : 6)
